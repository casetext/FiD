...
class GenerationMixin:
    ...
    def _prepare_encoder_decoder_kwargs_for_generation(
        ...
        if "encoder_outputs" not in model_kwargs:
            ...
            model_kwargs["encoder_outputs"]: ModelOutput = encoder(input_ids, **encoder_kwargs)
    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if self.config.is_encoder_decoder:
            ...
            model_kwargs["encoder_outputs"] = BaseModelOutput(last_hidden_state=model_kwargs["encoder_outputs"])
